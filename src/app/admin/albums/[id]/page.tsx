      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
        <AlbumForm
          album={{
            ...
            ruleMaxRatingHalf: found.ruleMaxRatingHalf,
            ruleUnratedOnly: found.ruleUnratedOnly,
            ruleIsoMin: found.ruleIsoMin,
            ruleIsoMax: found.ruleIsoMax,
            ruleApertureMin: found.ruleApertureMin,
            ruleApertureMax: found.ruleApertureMax,
            ruleExposureMin: found.ruleExposureMin,
            ruleExposureMax: found.ruleExposureMax,
            ruleFocalLengthMin: found.ruleFocalLengthMin,
            ruleFocalLengthMax: found.ruleFocalLengthMax,
            ruleWidthMin: found.ruleWidthMin,
            ruleWidthMax: found.ruleWidthMax,
            ruleHeightMin: found.ruleHeightMin,
            ruleHeightMax: found.ruleHeightMax,
            ruleBytesMin: found.ruleBytesMin,
            ruleBytesMax: found.ruleBytesMax,
            ruleCamera: found.ruleCamera,
            ruleLens: found.ruleLens,
            ruleMime: found.ruleMime,
